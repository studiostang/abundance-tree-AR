...
const snapGrid = [
  // Tier 0 - inner ring
  [-0.12, 1.30], [-0.06, 1.28], [0.0, 1.27], [0.06, 1.28], [0.12, 1.30],
  [-0.10, 1.35], [-0.04, 1.33], [0.04, 1.33], [0.10, 1.35],
  [-0.13, 1.40], [-0.06, 1.38], [0.0, 1.37], [0.06, 1.38], [0.13, 1.40],
  [-0.08, 1.43], [0.0, 1.42], [0.08, 1.43],
  [-0.11, 1.32], [0.11, 1.32], [-0.05, 1.45], [0.05, 1.45],
  [-0.14, 1.37], [0.14, 1.37], [-0.09, 1.29], [0.09, 1.29],
  [-0.07, 1.41], [0.07, 1.41], [-0.03, 1.44], [0.03, 1.44], [0.0, 1.31],
  // Tier 1 - mid ring
  [-0.20, 1.28], [-0.16, 1.26], [-0.10, 1.25], [0.10, 1.25], [0.16, 1.26], [0.20, 1.28],
  [-0.22, 1.33], [-0.17, 1.31], [0.17, 1.31], [0.22, 1.33],
  [-0.20, 1.38], [-0.15, 1.36], [-0.08, 1.35], [0.08, 1.35], [0.15, 1.36], [0.20, 1.38],
  [-0.22, 1.43], [-0.16, 1.41], [0.16, 1.41], [0.22, 1.43],
  [-0.19, 1.47], [-0.12, 1.46], [0.0, 1.46], [0.12, 1.46], [0.19, 1.47],
  [-0.21, 1.35], [0.21, 1.35], [-0.18, 1.44], [0.18, 1.44],
  [-0.14, 1.29], [0.14, 1.29], [-0.23, 1.40], [0.23, 1.40],
  [-0.17, 1.48], [0.17, 1.48], [-0.09, 1.49], [0.09, 1.49],
  [-0.21, 1.30], [0.21, 1.30], [-0.13, 1.27], [0.13, 1.27],
  [-0.19, 1.42], [0.19, 1.42], [-0.11, 1.50], [0.11, 1.50],
  [-0.24, 1.37], [0.24, 1.37], [-0.15, 1.51], [0.15, 1.51],
  // Tier 2 - outer ring
  [-0.30, 1.27], [-0.26, 1.25], [0.26, 1.25], [0.30, 1.27],
  [-0.32, 1.32], [-0.28, 1.30], [0.28, 1.30], [0.32, 1.32],
  [-0.33, 1.37], [-0.29, 1.35], [0.29, 1.35], [0.33, 1.37],
  [-0.31, 1.42], [-0.27, 1.40], [0.27, 1.40], [0.31, 1.42],
  [-0.30, 1.47], [-0.25, 1.45], [0.25, 1.45], [0.30, 1.47],
  [-0.28, 1.52], [-0.22, 1.50], [0.22, 1.50], [0.28, 1.52],
  [-0.34, 1.44], [0.34, 1.44], [-0.26, 1.54], [0.26, 1.54],
  [-0.32, 1.49], [0.32, 1.49], [-0.29, 1.55], [0.29, 1.55],
  [-0.27, 1.28], [0.27, 1.28], [-0.31, 1.53], [0.31, 1.53],
  [-0.24, 1.56], [0.24, 1.56], [-0.33, 1.51], [0.33, 1.51],
  [-0.35, 1.39], [0.35, 1.39], [-0.28, 1.57], [0.28, 1.57],
  [-0.25, 1.33], [0.25, 1.33], [-0.30, 1.58], [0.30, 1.58],
];

snapGrid.forEach(([x, y], i) => {
  const tier = i < 30 ? 0 : i < 110 ? 1 : 2;
  const z = (Math.random() - 0.5) * 0.04;
  SNAP_POINTS.push({ x, y, z, tier });
});
